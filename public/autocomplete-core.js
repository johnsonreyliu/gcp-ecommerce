...
$.getJSON("products.json", function (data) {
      ...
      console.log(items);
      itemsMapped = items.map(function (n) { return { label: n } });
      console.log(itemsMapped);
    });

    setTimeout(function() {
      console.log('running auto complete');
...
console.log(matches);
      ...
      autocomplete({
        input: document.getElementById('autocomplete-tags'),
        minLength: 1,
        ...
        fetch: function (text, callback) {
          ...
          callback(itemsMapped.filter(function (n) { 
            console.log(n);
            if(n.label != null){
...
// var conts = continents.map(function (n) { return { label: n, item: n, group: "Continents" } });
